...
chunks=[]
chunk_embeddings_2d=[]
for file in give_all_files("../rawData/embeddings")[:1]:
 content=read_file_content(f"../rawData/embeddings/{file}")
...
print("top_matching_chunk_index:",top_matching_chunk_index)
...
# print("top_matching_chunk",top_matching_chunks)
